...
<title>Welcome criticalceramics.org - Hostmonster.com</title>
        ...
        <tr>
          ...
          <td width="100%" valign="top">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td align=right style="border-bottom: 1px solid #999; border-right: 1px solid #999; padding: 5px;background-color: white;"><a href='http://www.hostmonster.com' style='color: #000; text-decoration: none; font-weight: bold;'>Web Hosting - courtesy of www.hostmonster.com</a>&nbsp;</td>
              </tr>
            </table>
          </td>
          <td><img src="//www.hostmonster.com/media/shared/general/_hm/button-end.jpg" width="6" height="37"></td>
        </tr>
      </table>

      <!-- Main nav end -->

      <div style="background-color:white;padding:12px 0 0 12px"></div>

      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:10px">
          <!-- body area -->

<script type='text/javascript' src=//www.hostmonster.com/media/shared/general/jquery/jquery.min.js></script>
<style>
.icontent {
    width: 1035px;
    height: 700px;
...
<script>
    ...
    pageTracker._trackPageview("/parked/dns/criticalceramics.org/%2Fwp-content%2Fplugins%2Fwp-spamfree%2Fjs%2Fwpsfv2-js.php");
</script>
...
<hr class="bbar" />
    ...
    <div id="footer" style="width:auto">
        <div class="sub_cont"><div class="sub_bottom hie6"><div class="rc cbl"></div><div class="rc cbr"></div></div></div>
        <ul id="footer_links">
            <li class="first"><a href="http://www.hostmonster.com/">Home</a></li>
            <li><a href="http://www.hostmonster.com/cgi/info/hosting_features">Hosting Features</a></li>
            <li><a href="http://www.hostmonster.com/cgi/help">Help Center</a></li>
            <li><a href="http://www.hostmonster.com/cgi/info/contact_us">Contact Us</a></li>

            <li><a href="http://www.hostmonster.com/cgi/info/about_us">About Us</a></li>
            <li><a href="http://www.hostmonster.com/cgi/signup">Domain Check</a></li>
            <li><a href="http://www.hostmonster.com/cgi-bin/partner">Affiliates</a></li>
            <li><a href="http://www.hostmonster.com/cgi/terms">Terms</a></li>
        </ul>
